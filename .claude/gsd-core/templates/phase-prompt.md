...
<!-- For checkpoint task examples and patterns, see @/home/jm/projects/mv2-save-editor/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/jm/projects/mv2-save-editor/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/jm/projects/mv2-save-editor/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/jm/projects/mv2-save-editor/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
