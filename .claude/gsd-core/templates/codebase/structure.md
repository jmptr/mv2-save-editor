...
- Usage: Reference from command with `@/home/jm/projects/mv2-save-editor/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/jm/projects/mv2-save-editor/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/jm/projects/mv2-save-editor/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
