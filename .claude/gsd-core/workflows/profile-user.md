...
Key references:
- @/home/jm/projects/mv2-save-editor/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/home/jm/projects/mv2-save-editor/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/jm/projects/mv2-save-editor/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/jm/projects/mv2-save-editor/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/home/jm/projects/mv2-save-editor/.claude/gsd-core/USER-PROFILE.md" "/home/jm/projects/mv2-save-editor/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/jm/projects/mv2-save-editor/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/jm/projects/mv2-save-editor/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/home/jm/projects/mv2-save-editor/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /home/jm/projects/mv2-save-editor/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /home/jm/projects/mv2-save-editor/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/jm/projects/mv2-save-editor/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/jm/projects/mv2-save-editor/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/jm/projects/mv2-save-editor/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/home/jm/projects/mv2-save-editor/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /home/jm/projects/mv2-save-editor/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/jm/projects/mv2-save-editor/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        /home/jm/projects/mv2-save-editor/.claude/CLAUDE.md
```
