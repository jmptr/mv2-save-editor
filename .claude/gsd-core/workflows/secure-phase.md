...
```
Agent(
  prompt="Read /home/jm/projects/mv2-save-editor/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/jm/projects/mv2-save-editor/.claude/gsd-core/templates/SECURITY.md`
