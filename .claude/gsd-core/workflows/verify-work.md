...
<template>
@/home/jm/projects/mv2-save-editor/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/jm/projects/mv2-save-editor/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/jm/projects/mv2-save-editor/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/home/jm/projects/mv2-save-editor/.claude/gsd-core/workflows/diagnose-issues.md
