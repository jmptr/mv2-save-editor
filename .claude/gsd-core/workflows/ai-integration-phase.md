...
<required_reading>
@/home/jm/projects/mv2-save-editor/.claude/gsd-core/references/ai-frameworks.md
@/home/jm/projects/mv2-save-editor/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/jm/projects/mv2-save-editor/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/jm/projects/mv2-save-editor/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/jm/projects/mv2-save-editor/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/jm/projects/mv2-save-editor/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/jm/projects/mv2-save-editor/.claude/agents/gsd-eval-planner.md for instructions.
