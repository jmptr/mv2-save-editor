...
- [ ] 05-05-PLAN.md — Shared primitives: token stylesheet + VirtualList (32px) + EditableCell [BROWSE-02/03, EDIT-02]

**Wave 3** *(depends on Wave 2)*

- [ ] 05-06-PLAN.md — SummaryBar (BROWSE-01, click-to-edit int64 D-06) + BankPanel (BROWSE-02/04, EDIT-02)
...
| 5. Renderer UI — Browse, Search, Edit, Preview | 2/8 | In Progress|  |
