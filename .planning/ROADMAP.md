...
- [ ] 02-01-PLAN.md — FieldTable model + offset-free ViewModel contract + test harness (fixture + no-offset scanner)
- [ ] 02-02-PLAN.md — Structural component-walk spine: version → SaveHeader → entity/component walk + SC-5 bounds + version tolerance + delta-0 integrity
- [ ] 02-03-PLAN.md — Wallet parser (currency-by-ID, authoritative) + Experience parser (XP/Cap/Level, context-validated)
...
| 2. Format Parser + FieldTable Model | 0/5 | Not started | - |
