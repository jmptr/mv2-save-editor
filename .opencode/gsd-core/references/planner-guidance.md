...
**Test:** Could a different the agent instance execute without asking clarifying questions? If not, add specificity. See @/home/jm/projects/mv2-save-editor/.opencode/gsd-core/references/planner-antipatterns.md for vague-vs-specific comparison table.
