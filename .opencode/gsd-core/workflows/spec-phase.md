...
ones). Reference: @/home/jm/projects/mv2-save-editor/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/jm/projects/mv2-save-editor/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/jm/projects/mv2-save-editor/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/jm/projects/mv2-save-editor/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/jm/projects/mv2-save-editor/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/jm/projects/mv2-save-editor/.opencode/gsd-core/templates/spec.md.
