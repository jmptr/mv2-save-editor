...
Display `Phase ${PHASE_NUM} ✅ ${PHASE_NAME} — Verification passed`, run `@/home/jm/projects/mv2-save-editor/.opencode/gsd-core/workflows/transition.md`, then Proceed to iterate step.

**If `stale`:** handle_blocker: "Stale verification for phase ${PHASE_NUM}."

**If `human_needed`:**

Read `human_verification` items. In text mode (`--text` or init `text_mode=true`), replace question with a numbered list and typed choice. Otherwise display items and ask:
...
On "All good — continue": set VERIFICATION frontmatter `status: passed`, display `Phase ${PHASE_NUM} ✅ Human validation passed`, run `@/home/jm/projects/mv2-save-editor/.opencode/gsd-core/workflows/transition.md`, then iterate.
...
Read and execute: `/home/jm/projects/mv2-save-editor/.opencode/gsd-core/references/autonomous-smart-discuss.md`
