...
```
Agent(
  prompt="Read /home/jm/projects/mv2-save-editor/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/jm/projects/mv2-save-editor/.opencode/gsd-core/templates/VALIDATION.md`
