...
INSTALL_JS_GLOBAL="/home/jm/projects/mv2-save-editor/.opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/jm/projects/mv2-save-editor/.opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
