...
- **Global scope**: `/home/jm/projects/mv2-save-editor/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/jm/projects/mv2-save-editor/.opencode/notes/`)
...
2. Glob `/home/jm/projects/mv2-save-editor/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/jm/projects/mv2-save-editor/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/jm/projects/mv2-save-editor/.opencode/notes/` — works in any directory
