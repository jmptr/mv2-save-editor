...
- Usage: Reference from command with `@/home/jm/projects/mv2-save-editor/.opencode/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/jm/projects/mv2-save-editor/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/jm/projects/mv2-save-editor/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
