...
**Verification depth scales with `asvs_level`** (see @/home/jm/projects/mv2-save-editor/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
